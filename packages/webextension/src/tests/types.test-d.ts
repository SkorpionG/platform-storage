...
import type { WebExtensionStorageArea, WebExtensionStorageAreaName, Serializer } from "../index";
...
*/
type Conforms<Area> = Area extends WebExtensionStorageArea ? true : false;

describe("WebExtensionStorageArea", () => {
